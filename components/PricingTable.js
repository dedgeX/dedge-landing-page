      ...
      <table className="min-w-full bg-gray-800 border border-gray-700">
        <thead>
          <tr className="bg-gray-900">
            <th className="py-3 px-4 border-b border-gray-700 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Feature</th>
            ...
            <th className="py-3 px-4 border-b border-gray-700 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Lifetime Edge</th>
          </tr>
        </thead>
        <tbody>
          <tr>
          ...
          <tr>
            <td className="py-2 px-4 border-b border-gray-700 text-sm text-gray-300">Price (SOL/month)</td>
            <td className="py-2 px-4 border-b border-gray-700 text-sm text-gray-300 font-bold">Free</td>
            <td className="py-2 px-4 border-b border-gray-700 text-sm text-gray-300 font-bold">0.2</td>
            <td className="py-2 px-4 border-b border-gray-700 text-sm text-gray-300 font-bold">1</td>
            <td className="py-2 px-4 border-b border-gray-700 text-sm text-gray-300 font-bold">10 (one-time)</td>
          </tr>
        </tbody>
      </table>
    </div>
